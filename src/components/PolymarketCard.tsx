  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <h3 className="mb-4 text-sm font-semibold leading-snug text-gray-900 dark:text-white">{title}</h3>
            ...
            return (
              <div key={outcome}>
                <div className="mb-1 flex items-center justify-between text-xs">
                  <span className="font-medium text-gray-700 dark:text-gray-200">{outcome}</span>
                  <span className="font-mono font-semibold text-violet-600 dark:text-violet-400">{pct}%</span>
                </div>
